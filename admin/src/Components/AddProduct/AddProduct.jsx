...
const AddProduct = () => {
  ...
  const AddProduct = async () => {
    ...
    await fetch('https://e-commerce-artesaniasjimenez-backend.onrender.com/upload', {
      method: 'POST',
      headers: {
    ...
    if (dataObj.success) {
      ...
      console.log(product);
      await fetch('https://e-commerce-artesaniasjimenez-backend.onrender.com/addproduct', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
